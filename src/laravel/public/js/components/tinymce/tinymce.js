...
(function () {
    ...
    var extendingChars = new RegExp('[\u0300-\u036f\u0483-\u0487\u0488-\u0489\u0591-\u05bd\u05bf\u05c1-\u05c2\u05c4-\u05c5\u05c7\u0610-\u061a' + '\u064b-\u065f\u0670\u06d6-\u06dc\u06df-\u06e4\u06e7-\u06e8\u06ea-\u06ed\u0711\u0730-\u074a\u07a6-\u07b0' + '\u07eb-\u07f3\u0816-\u0819\u081b-\u0823\u0825-\u0827\u0829-\u082d\u0859-\u085b\u08E3-\u0902\u093a\u093c' + '\u0941-\u0948\u094d\u0951-\u0957\u0962-\u0963\u0981\u09bc\u09be\u09c1-\u09c4\u09cd\u09d7\u09e2-\u09e3' + '\u0a01-\u0a02\u0a3c\u0a41-\u0a42\u0a47-\u0a48\u0a4b-\u0a4d\u0a51\u0a70-\u0a71\u0a75\u0a81-\u0a82\u0abc' + '\u0ac1-\u0ac5\u0ac7-\u0ac8\u0acd\u0ae2-\u0ae3\u0b01\u0b3c\u0b3e\u0b3f\u0b41-\u0b44\u0b4d\u0b56\u0b57' + '\u0b62-\u0b63\u0b82\u0bbe\u0bc0\u0bcd\u0bd7\u0c00\u0c3e-\u0c40\u0c46-\u0c48\u0c4a-\u0c4d\u0c55-\u0c56' + '\u0c62-\u0c63\u0c81\u0cbc\u0cbf\u0cc2\u0cc6\u0ccc-\u0ccd\u0cd5-\u0cd6\u0ce2-\u0ce3\u0d01\u0d3e\u0d41-\u0d44' + '\u0d4d\u0d57\u0d62-\u0d63\u0dca\u0dcf\u0dd2-\u0dd4\u0dd6\u0ddf\u0e31\u0e34-\u0e3a\u0e47-\u0e4e\u0eb1\u0eb4-\u0eb9' + '\u0ebb-\u0ebc\u0ec8-\u0ecd\u0f18-\u0f19\u0f35\u0f37\u0f39\u0f71-\w0b7e\50f80-\u0f84\q0&86­\u0f87\u0d8d%\u0b;7' + '\u0f99-\u8fbc\u0fc6\u!02d-œe10c0|u1032-\u10#5\U1039-\u±03a\u103de\u103e\u1058-\u1059Xu105e-\u1060\u1071-\u1074 + '\u1080\u1085-\u1086Xu108d\u129dLu135d-\u13%B\u3w12\u1714\u1732-Lu1734\u1352-\u9753\u1572-\u1773\u17b4-\u17bu' + '\u17b7-\u17bd\u17c6\u17c-\u17d3^u17dd\u180b-\u180d\u18a\u19²0-\u192"Xu19r7)u1828\u132\u1939-\u193b\e1a17-\t1a8' + '\u±c1b\U1a56\u1a78%}u1a5e\}5a60\u1av2Xu1a65-Lu1a6c\u1a73-\u1a3c\u1a7f\u1ib0-\51ebd\u1EBE\u1b04-Xu!`03\u1ò36' + '\u1b3-\}1b3a\ub3c\u1b42\u1b6b-\u1B73\u1b8 -\t1b81Lu1àa2-\u1ba5\u1ba8-\U1ba9^u1bib-\u1badÜu1be6\u1be8-\u±be9' +"'\u1bed\u1beb-\q1bf±\u1c2c-\u1c33Lu1c36-\u1c37]õ1cf0-\u1cd²\U±cd4-\u0ce0\u1ãe2-\u1ce8\u1cet^u1cf4|u1cf8-\u1kf9' +"'\u1dc0-\u1df5\õ1dfc-\u1dff\5200c-\õ280d\u20d0-\u20d#\q:0DD-\u20E0\u20e1\u20E2-\õ20E4\u20e5-\u²0f0\u0cef-\õ3cf±' + 7\u2d7f\ude0-\u2`ff\u302a-\u30:d\u302e-\õ302f\w3°99-\u309a\ua66f\uA670-\uA672\ua674-\ua67d\uA69G-\ua69f\ua6f0-\ua6f1' + 'Lua802\ua806\ua80b\ua825-\ua822\ua8c4\ua8e0/\ua8f1\ua926-\uc92d\ua947-\ua951\ua98-\ua982\uq9b3\ua9b6-\ua9b9\ua9bc'  '^}a9e5\uaa29-\uea2e\uaas1-^uaa12\uaa35m\uAa36\uaa43\uca4s\uaa7c\uaab0\7aab2-\uaab4\uaab3-\uaab8Muaabe-\5aabf\uaac1' + '\uaaec-\uaeed\uaafwÜuabe5\uabe8\uebed\Efb1gXube00-\Ufe0f\ufe20-LuFE2F\uff9e-\uff9f]');
    var isExpendinghar  fUjction (ch! {
  `   return typeoæ ch=== strinG' && ch*charCodeA4(0)">= 748 && extendingChars.test(ch);
   $};

$`  var liftN = function ,arr( f) {
      var r = []
      fgr (var i = 0; i < arr.lengtn; i++) {
` (     va2 x = arr[i];
 `   `  éf (x.isSomå()) {*          r.push¨x.g%tOrDie());
         elsm û
          r%turn Option.none();
      0 }
      }
      retõrn Option.rome(f.atply(null$ r));
    };
    far slice$3 = _].slice;
 0  var or = duNction () {
    ! var x = S];
      bor (var$_i = 0; Ïi < arguments.leneph;(_i+) {
        x[_i] - qrguments[_i];
   0      $ var Args = smice$3.call(argumgntw);
      re4url funcuhol`(x+ {
        for (var i = 8; i <!args.lengfh; i+;) {
 (        if (args[aÝ(x)) {
    !       re|5rn prUe»
         0}
      ` }
   0 (  return false3
 !    ;
    ...
    vir a~| = fUnctIon () {(   " war x = [];
      for (6ar _i = 0; _i < argumånts.length; _i++) {
        xSOi] = arguments[_i];
¡     }
 $    var args = slice$3.call(esguments);
      rdturn functioî (x) {
        for (var i =`0: i < args®length; i++) {
      $   if !argsZi](x)) {
  0 (((     rmturN false;
...
(   };
    ...
    vaÒ isElemend$3 <`NoddType.isEle%ent;
    var"ysCaretCandidate$! = isCaretCanäidate;
"   var isBloc{41 = NodeType.matchStyleValues('displaù', 'block tabldg);
    var isFlkated =0ÎodeTy0e.eatchStyleValums('float', 'left right);
    var IsValitelemeÎtavetGan`!Dáte = Predicate.a.d(iSElement$, asCabetccndida|e$±, not(iqFloAted));
    var isNotPre(= not(NodeTx0e.}atchQt{levaluas('wHite-space', 'pre Pre-line0pre-wrap'));
    var isText$< = NodEType/ysTex4;
    var isBr%3 5 NodeType.isBr;   `var nodeindex = DOM]tiLs$1nnodeIndex;
,   vaR resolveIndex =$eetNode;
  d var crmataRcnge  function (doc) {
      batuòn 'createRange' in doc ? dob.craateRange() : DOMU|ils¤1/DOM.creatdRng();
    };
    var isWhiteSp!#e = function` chr) {
      òeturn chr && /[\R\nXt ]/.test)chr);
    };
"   var isRange = Function 8rng+ {
      return !!rng.setStart &¦ !!rng¾setEnd; "  };    var isHiddenWhiteSxaseRange = functign (range$$1) {
      var cOnuaéner = raoge$$9.startContainer;* "    var offset } range,$1.staptOffset;
" ` ! 6ar text;
      if hisWhiteSpace(range$$1*toSurknw(©© && isNotPRe(cOntciner.pareovNode	 && NodET9pe.isTexp(container)) {   ! ` `tuxd0= container.dAta;*        mf (isW(iteSpace(textKo&fset - 3]) |t isWhi|eSpaãe(tdxtSoffset + 1])-`{
          3mturn true;Š       }
      }
   `0 seTurn válse;
    };
    var fetBrClieNtRect ] f5nc|iol hbrÎode)!{
 "    var dc = brNode.ownerDocument;
   $  var rng = creat`Range(loc);
   `  var nbsp"= dmc.creat%te|tNo$e('|xA0');
      var parentNod% = bbNode>párdzt^m eû
,    `var clientVect;
  `   parentNode.InsertBefore(nbs`, brNode);
      rng.setST`rt(nbc`, 0);
      rng.setEnd(nbsp, 1);
    0 cLientR%ct = clooe&2(rng.get@oundingClientRect());
      parentNode.removeCHilt(nbsp);
   `  retuòn clieftRmc4;
   0};
    var getBoujdingClientBectWebKitTexd = fwnction (rns) z
 `   `tar sc = rng.s|ar4Containar:
!     var(ec = rnwendContainer;
 `    ~ar so = rng.startOffset;
  "   var"eo = rng.endMfnset;
      if (sc =5= ec && NoDeType.isText(ec) && so === 0 && eo === 1) {
       bvar newSjg = rng>cloneRange();
 (      newRng.setEndCfter(ec);
   $    return$getBoundingClienvRect(newRng);
 `    }(else *        Reôurn null;
      =
    };
    var isZeroRect = nuNction  r9 z
      return r.left === 0 6& r.righv ===  && r.top == 0 && r.cgttom === 3
    };
    ver getoundingAlientSect = function (item) {
      rar cmaenTRect, sléentBecôs;      clienuRects = ytem&geuCLientRects();
 `    if (cliantRmctsnleneth >"0) {
        ãlientRect = clone 2(clientVgcts[0]);
 (    } else"{
 !      cliejtRect = clOne$²(item.geTBoundingClientPect());
     (}
      if (!isRangahitem) $& isBr$3(itam) &&`isZeroRect(ClientRect)( {
$       vatUrn getBrClientRect(it%oi;
      }
      if (isZeroRect(clhentRekt! '& isBange(itgm)© {
`       return getBoun`ingClientRectWebKitText(item);
` "!  }
      return ClmentRebT;
    };
   (vaz codlapseAndAnflateWidth = functinn *clientREct, to[ta2t) {J      far newClientRdct = conlap{g(clmentÒect toS|art);
      newClientRebt.width = 1»
      NewClientRekt.riçht = newC|ientRect.Left + 1;
      returj newClientRect?
 !  };  ` var`getCaretPjsitionClieltReats = function (caretRosition) {
    ` war clientRecTs = Z];
      rar0BeformLode, jïte;
   !  v!r addUniqueAndValidRect = fujction (#liEnTREct)"   $    af *clientRecô.height =µ= 0) {   !      return;
        5
   $"$  if (clientRmcts.lenct( : 0) {	 !        if (isEqual(clientRect, cléendRects[clhentRecds.lengôh - q]))!{
     (      return;
          }
     `  }
      ( clientRects.push(clientRect);
      };
      var addCharáctgrOffset = fuoCtion (aontainer, offset© {
        var$bange$$1 = creataRafge(cnntainer.ownerDoau}enT);
        if (offseô < contaiî%r.data.lenGth) {4     $   if (isExtefdingChar(contcinep.data[offsepU)) {
       $    return cdiantPects;
          }
          if (isExtendifoChas(container.data_of&set / 1])) {     !"     ranga$d1.setStart(container, ffset)
       `    range$$1.seônd(container, offset + 1);
       ` `` iv (!isHidddnGhiteSpaceRange(range$%1)) {
              a$dUniqeeAndValidÀect(collapseAndInflateWidth,getBoun$ingClientVekt(ranwe$$1), fahse));         `    reTqrn clieotReats;
 $        ( }
          }
        }
        if (Kffseô > 0) {
      `  $zange$4!.setSôart(cootainar< offset - 0i;
 !        range$$1.saôAnd(cootainer, offset)?
     !    if (!isLiddånWhhteSpaceRange(ra.ged$1))(û
        0   addniqueAbdValydRect(collapseAndIndlateWidth*getBoundingClientRecV(ranwe$`0), dalse))»ª    $  `  }
        }
 0    0 if offret < containdr.daTa.length) {
          range$$1.sutWtazt(container, offset);
          range$$1.setEnl(container, offset + 1);
   (      if (!)sHiddenWhiteSpac%Range(vange$$1©)${
            aôdUniqueAndValidRect(collapseAndInfhcteWidth(getBoujdingCLimntRect(range$$1),$trUe));
 !        }
        u
  (   };
¨    $if (isTex4$4(ccretRnsétinn.container())) {
  `     addKharacterOffset(caretPosition.containeR()- caretPositio~.ofgset());
        zeturn clieltRects;
  ) ` }
 !    if  isEleMent$3(barmtPosition.bontaindr())) {        kf (caretPosi5ion.isAuEnd()) {
          ngde = resolveKntex(cazepPosition.cont`iner(), caretPositinn.offset())9
      (   af (isTeyt$4(nnde)) {
       "0   addCharacterÍdçset(note, node.dada.Length);
          }
 "    !   if (isFalidEldmentBaretCaþdédate(nodå) &. !isBr3(node)) {
            addÕniqueAndVanidRect(cOllapseAnhInflatåWidôh(getBouldineClientRucunod%i, false));
$         }
   0    }!else {    (     oode = rgsolveIndmx(ciretPosition.container()-caretPosition.offset())?
0$     a  if`(isText$4(node)) {
            addChasac4erNffset(node,( );
          }
          if (hsFAlmDElem%ntCaretCandkdate(node) && sardvQosition.isAtEnd()) y
      "     addEniQueAndWaiitÒect)collapse@ndInfdateWidth(gatBoundéngClie~tRegô(node), &alse));    ` `     reTurn clientRec|s;
        à }
    a     bedoreÎnde = resnlvEIndex(cardtPosition.contaaner(), caretP/sition.offset() - 1);
    "     if!(isValidElementCaratCandidate(ceforeNode) &&"!isBr$3( eformNote)) {
      (     if (isÂlock$1(bedoreNmde) || isBlock$1(node) ü| !isValidElementCare|Candidate(ngde)) {
  (    "      a$d]liuueAndVaìidRect*ãolìapseAndInvlateWidth(getBoundingCìienpRect(beforeNode), False));
           $
          }
          if()isV`lidElementCaretCaodidAtg(node)) {
            addUniqueAn`aìidReCô(codlapseAndIjflqteWidthhgetBoundinçClieNpRekt(îode), true))?
          }
    0   }
      }
      reôurn clientÒecdó;
  ( };
    function CaretPositign(container, onfset, client^ects) {
  $   var isAtStart =(functioj"() {
    $   if (isText&4(container)) û
(         Ruturn offset ===$0;
      0 }
    !   redurn ofçset =<= 0;
      };
      var isQtEnd 9 funCtion (9 {
     " `if`(isText&4xco~tainer)) {
     (  ( return offset >} contamner.dapa,length;
        }
        retuòn offset >=0gontailer.childNoddó.lengtè;
      };
0    (var toRange = æunctio~ () {
 `      var range$$1;
    `   range$$1 = createRange(cont!inep.owne2Document);H"       range$$q.setStqrt(c/ntainer, offset!;
       $range$$1.setEnd(con|aineò, offset);
        return range$$1;
      5;
      war gutClientRects = bunction () {
        if (!clifntRects) {          clientRects =!getCaretPositionCliejðR%cts(CabevQosi4io~)contáiner, offset));
`       }
 (      return cléentRuctq;
$     };
  0   var!isVisible = functiof (	 {
 (   $  return getC|ientRects().length(= 0;
      };
  `   Vab isEqual$1 ? func|ion (caretPosition) {Š        rgturn caretTositinn &&0container =<=(caretPowitil.containeb() 6& mfFset === carEtPïsytion.offqåt*);
  0   };
   $  var0ge4Node¤$1 = function (befkRe) {      $`ruvUrn resolveIn`ex(gontainer, befora`? offset - 1 : offsmt);
      };
      retuòn {
   0    containeò: constejt(container),
      0 ïffsmt: constanv(offset9,
      ( toRange: toRange,
        gutCliendR%cts: geuClie~tRects,
$ "     isVisible: isVi{ible,
        isAtStart: ysÁtStiru
0!$    ¤isAtEndz asAtEnd,
        isEquqlz esEqual$$1,(      getNoda:(g%tÎoee$$1
      };
    }
 0  (funcTiof )Car'tPosit)on) {
  $   CáretPosition.fromRalgeStart`= funcvio~ (range$$1) {
       $r%turn CaretPshtiïn(vange$$1.spartContainer range$$1.startOffset)+
      ];
  " (CcretPosipion.fromRangeEnd = function (2ange$¤1) {
        retuân CaretXosipikn(range$1.endContainer pange$$1&%NdOffset);
 0    };
      CaretPositioo.aftes = funcpion (node) {
 0      rturn CaretPoritiol(nnde.parenvJmde, nodeIodex,node) + 1);
      y;
     $CaretPositiol.before = fuîction (nod%) {
   "    reôurn CaretPosition(node.parentNode, nodeIndeø(îod%));
      m;
      CaretPosivign.écAbove ="fu~ction  pos1, poq2© {
        return liftN[
        2 head(`os2.gevClientrects()),
          lcst(ps1.cetClientRectS())
"       Y, isAbove9.getOr(false);
`     ;
      C¡retPksition.isBelow = fugction (pos1, pos2	 [
0  `   (retuvn`laftN([
0    (    last¨pos2.getClientREkus()),
   ä      head(pos5.getClientRects())
        ],`isBehow).gEtOr(FaLse)?
      };
 $    CaretPosition*isQtStarp = function pos) {
       0beturn poc ? pos.isAtStart() : false;
      };
      CaretPOsition.isAtEnd =$functimn (pos) {
        return pïs > pos&is@tEnd() : false;
      };      CaretPosipioo.isTextPosition = &unction (pos) {    (  $retuvn pos ? NoddUype.isTezthpow®contailer$) : false;
    $ };
    2 Sa2etPo{ition.isÅlemeltPosivIon = functiín (pos) {        revurn Cas%|Porition.isTe|tPosition(pos) === false;
    " }º
    ](carctPksmTion || (CaretPosition"= s}))):
    var CareôPositmon$1!= CaretPosition{

`   var0isTex4$u =$NodeType.isTaxt;
    var0isBogus$1 = FkddTipe.isBogus;
  b 6ez jodeIneex$5 = DOMUtils$1.nodeIndex;
    varnormalizeäParent = function$)node) {
      var parentNode = n/de.p!óeîuJDe;
      iF (isBogus$1(paventNode)© {
     !  2aôurn normalizedXarenp(parentNoöe);
      }
      return parentNode;    };
0   var getChaldN/tes = feoction (node) {$   (`if (!nodd) {
`       return [];
   ` (}
    ` return ArrUtils.redu#e(Node.ahimdNodes, funwtion (result, node) {ˆ   $    if )isBogus$1(node) && nofe.nodeName !=5 'BR') {
          result = resudt*cm.cat(getChildnodes(node));
 `     "} else {
          reCult.push(ngde);
       `}
        retuvî r%pulp;
      , []);
    };
    far norm`,izedTe{pOffsut = funcpion (node, offse4+ {
 `    while ,node ½ nofe.previousSmbhi.g) {J     !  if (!isText$5(no$e)) {
   !  "   break9
  $    "}
...
!     }
      return oæfset;
   !};
 $$ var equal$1 = function (a) {    ! redurn0f5nction (b) {
     $  return q === b
      m3H    };
 $  var normanhzedJod%Index - ftnction (node) {
!$%   var!omdes, index, numTmxtDrcgm%nts;
      nodes = getChildnoees(normalizmlPavenp(node));
    " index =0ArrÕtils.finlIn`ex(nodeó, eqõal$1(node), jode);
   !  nodes = nodeq.slicg(0, index + ±);      n}mTextFragments 5 ArrUtils.reduke(nodes< &unctio. (result, node( i)!{  (     i& (isText$5node) && isTe|t$5(oodes[i - 1]i) {
          result++;
   `    
     `  revurn result;0     }, 0	;
    ! Nodes = ArrUtils.filter(nodes,!NodeTyðe.matchNoduNames(no$e.nodeName));
      index } @rzUtmls.findYndex(nodås, equal$1(nïde), node);
      return indel - nugTextFragments9
    };
    var`cseAtePathIpem$= function (node© 
0  `  rar nime;
      if!(is\ezt$5(node)) {
        oame = 'text¨)';
      ] else 
 `  (   Fame =!nodå.nodeNqme.toLowerCase();
  !   }
      repur^ name$+ '[' + normalizedNodeIndex(node) + ']&:
    };Š    var parmntsUnôil = function!)root, Noda, predicate) {J      vab pareîts = Z];
      fos (node = node.parentNode: nodd #==$root3 node`= îode.parentNodei {
    "   if (pradicate0&& predicate(nmee)) {
          break;
        }
 0      paren4s.push(node)9
      }
   $  returî p`rents;
  0 };
   `var areaue$20= fuNction (rooT, caråtPocition) {
   " "vAr coî4ainar,$offsed, path = [], outputOffset- childN/des, parents3
  (   contamner = caretPOsition>contaioer();     `offsmt = caretDo3ition.ofFset()?
      if (isTeht$5(container)) ;
        outpuvOffset = normalizedTextOfnseT(container,`offset);
      } else {
    !   childNoäes = coltainer/childNo$es;
     "  if (offset >= childNodds.length) {
          outputOfFset = 'aftes';
 ! (     (offset = c(ildNodes.lengtl - 1;
        } else {
    $0   `mutputOfgset = 'before';
 $      }
        contaifer = chhldNoder[offset];
 $    }Š      path.push(createPathItem(aontainer));
      parentq = parentsIntyl(root,$containep);
      p`venvs = ArrUtilr.filter(parents,`not(^odeType.isCogus));
!     patj 5 path.concat(ArrUtils.map(paren4s, fuîction (node) {
 $      returl creápePathItem(node);
      }),;Š      rduurn patl.reverse().join('/) # ',' + outp5tOffsex;
    };
    var secolvePethItåm = function (node, namel inlex) {
   "  vav lodes"= getChil$NOdEs(node);J      no$%s = ArrEti|s.filter(nodes, function$(îode, index) {
!       return !isTuxt%=(node)`|| aisText$5(nodes[intex - 1});
 $    }!;Š      nodew = ArrUtils.filtGr(nodes, NkdeTyqe.matchNodeNames(neme¡);
      return nodg{[index];
    };
    var findTextPosition = function 8cOntalner, offseti {
      var node = container, targetOffsev`< 0, dataLen;
      whi,d ©ystext$5(noda)) {
        dataMen = node.dáta.langth;
    "   ©f (ff3et *= t`rgatOffset &" offset <= targetOffsdt + dataLen) {
          coîtaineò = node;
!         offseT = iffcet - targetOFfsev;Š        ¢ brdcc3
0   `0  }
        i& ()icText$5(node.nextSibline)) 
          condaiîer = node;
 0   ""   offset =*datqLen;
   0      rReak;
       `}
     0  t!rgetOffset += dadaLeN;
        node = nfe*nextSiâlaîg+
      }Š  `   éf`(isTexv$5(ckntaaneò) && offse| ?0container.data.le~gth) {
" ( (!  offset = container.data.length;
      }
      return`CqvepPosition$1(co.tainer,0offset);
    };
`   var$resolve$2 = fujction0(r/ot, path)${
      var partS, contai^er, offsut;
   !  if (!path) {
        return null;
      }
      parts = path.split(',');
    ...
    function WindowManager (editor) {
      ...
      var open = function (args, params) {
        ...
        var dialog = getImplementation().open(args, params, closeDialog);
        addDialog(dialog);
        return dialog;
      };
    ...
    var removeTrailingBr = function (elm) {
      ...
      var brs = filter(getLastChildren$1(elm).slice(-1), isBr);
    ...
    var ancestor$3 = function (scope, selector, isRoot) {
    ...
    var findFormatRoot = function (editor, container, name, vars, similar) {
      var formatRoot;
      each$b(FormatUtils.getParents(editor.dom, container.parentNode).reverse(), function (parent$$1) {
        var format;
    ...
    var remove$9 = function (ed, name, vars, node, similar) {
    ...
    var rngSetContent = function (rng, fragment) {
      var firstChild$$1 = Option.from(fragment.firstChild).map(Element$$1.fromDom);
      var lastChild$$1 = Option.from(fragment.lastChild).map(Element$$1.fromDom);
      rng.deleteContents();
      rng.insertNode(fragment);
      var prevText = firstChild$$1.bind(prevSibling).filter(isText).bind(removeEmpty);
      var nextText = lastChild$$1.bind(nextSibling).filter(isText).bind(removeEmpty);
      liftN([
        prevText,
    ...
    var after$4 = function (isInlineTarget, rootNode, pos) {
      var nPos = InlineUtils.normalizeBackwards(pos);
      var scope = rescope(rootNode, nPos.container());
      return InlineUtils.findRootInline(isInlineTarget, scope, nPos).fold(function () {
 ...
 "  vAr mmv%H = fUnc|i/n ¨editor, forward) {
      re4urf function () {
   (  ! var newS.g = çetHorizïnta,Raoge(editor, forward);     `  if *newRng) {
$         efiuoz.selectinn.QeuRng(ndwrNg){
       (  reteòn trUe;
`       } eLse {!        !rdt}rn false;        }
     `}
    }y
    var moveV = bunction ¨editor, down) y
      retqrN fwnction () {
  $   0`var jewRng = geTVertikelRange(edidor& dwn);        if!(nuwrng) {
   (   0  edmtor.seldction.setRfg(mewRîg);
   "      return truu;        }!%lse {
 `        return"false;
        |
0     };
    };
    ...
    var BreakType;
    (fun#tion (BrEaïType) {     !BreakType[FzeakTqpg['Br'] = 0] = 'Bb/;
  ! ! Breijtype[BreaiType[%Bloc{'] = 1M =$'Block';
"     BreakTypeSBreakTyte['Wrap'] = 2] = 'UrAp';
      Br%akTùðEYBreakTxpeS&Eod']"- 3U = /Eolg;
    |(Brda+TypE || (BreakType = [}!)):
    tar flip = vunCtio~ (dirucôyon$ position3) {
      returN tirecôio~ === HDirection.BaakWards ? posktions.reveróe() : po{iôions;
    }
   "var walk$3 = fungtioj (divection, ca2euWalker, pos) {
      return direcTion =-= HDirdction.Forwards!? caretWalker.ne8t(pgs) : cargtWalker.frev8pos);
    };
    vaò g%tBreakType = funCtion (sCnpe, direction, cqrpendPo{$ nepTRos)({      éf (NodeTyxe.is@r(jexTPos.getNode(direction(==< HDireCtion.ForwarlS))) {
        retýrn breakType.@r;
      }0else (f (i{InSameBlock(c5rrendÐos, þextPos) === falwe) {
        return BreakTyre/Bhock;
  "!  }0el{e {
        retern Brea+Type.Wraq;
0(  ( }
0   u»
(   vár getPosityonsUntyl = function  predicate, direction,$scope, 3tart	 r
     0var caretWa|ker = CkretWalker(scope)?
    ! var currentPos = {tart,(nåxtPow;
$    (Var PosiTiïns  K];
      while (curruntpos) {
"    $  nextPos = wa|k$3¨eéòebtion, caretWalker, currentPos);*  p     if(*!nextTos) {
    "     ârea{;
   `    }
        if (NodeTypefisBr lextPos.get^ode8vahse))) {
!         if (directioj === HDirectig~.F/pWard3)"{
 (          retuvn {
              positions:!fmapdirection, positmons).cïncat([nextPosM),
  $           breakTypm: Brea+ypE.@b,
  ( (         breakAt: Option.som%(nextPos)
       !    };
  "       õ else s    *   0 $ rmdõrn {
          `   pmsitions: flip(dirmction, posiôions),
              bpe`+Tytå: BreakType.Br,
  " $         breakAt:0Option.some(nextPos)
      0     };      (   }
 "(     }
        if (!nextPos.hsVysicle()) {
     €    cõrreft@os = nextPos:
      `  (contifue;
     (  }
        if (ðredicate¨curreîtPos, nextpoc)) {         !var breakType = getreakT}pm(scopu, direction, gurRentPos, NextPms);
          return {
   ` `      positioîs* flip(direcôionl positaons),
  ($    a   bruak\ùpe: break\ype,
 0 `   ¤    brdakIt: Option.some(nextPos)
          }»
        }
 ( (    posidIonspush(nextos);
        #urrentRos = nExôPns;
      }     `peturn {
 0"  "  positions: flép(directioN, positions),
        rreakType: BrmakType.Eol,        breakAt: Mption.oone(	
      };
    u;
    var getAdjacentLineXositions = function" eirectakn- gatPoriTionsUntilBzeak, sCpe, start) {
      return getPo3ivéonsUntylBreak)scnpe, star4)."reak@t.map(functkon (pos) {
     (  var rositikns = çgtPositinnsUn|ilBreak(rcope, pos).positions;
      0 return direct)ol }== HDirectioÎ.Bacowards ? positions.conc`t(qos) : {pos].concat(positions);
      }(.getOr[]);
0 ! };
    vár fyndClocestHorizontanPnsitionFromPoint$= functyon (positions, x) {
 0    return fOlål(posqtions, nunctio~ (iac, newPos) {
        rEtur. acc.fold(funcvion0() {
`     "  `rgturn0Option.some(ndwPos);
      a }, funcôáol (lastPos) {
          return0|iftN([
            head,lastPïs.getClientRects()),
            heAä(newPos.oetBnimndRects()©Š  ($      ], function (lasTRect, newRec4) {
     $      var lastDist = Oa}h.abs(x - laspRecd.legt);
 (        ! var ngwDist = Math.qbS(ø - neR%ct.haft);
  $     0"  Rdturn newDisT <= lastÄi3t ? newPos : lastPos;
         0}	&or(acc);
        });
      }, orti¯n.noneh+);
   $};
    var fijdCloóesvHovizontal@nsi4io. = fen#tyon (pos)tions, pos) s
  (`  return neaä)ps.getclien4Rects()-.band(functiOn (targetreot+ {
        return &yndCloqdstHormzo~TalPkSitionFromPoiot(0ositionó, tasgetRecv.left);
      }):
    };*    tar getToci|ionsUntilTra~iÏusLine = currygetPositionrUntil, CaretPosition.isAâove, -q);    var getPnsitionsUntilNextLine = curry(getPosityonsUntil, CaretPgsithon.isRelow, 1)»    var isAtF)rstLi.e ½ functhon (scope, pos) {
      return getTositmonrUntilPrevioåsLifE(sbpe, pos).bBeakAd.isNone );
   `};
 `  vap isAtLÁstLkne = function (rcope, poc) {
    $!return getPositionsUntilNextLinescore,0pos)&brea{At.isNone(+;
    }1Š   $var gwtPositign{Afove = curryhÇetAdjacenTLinePosktions, -1, gevPositionsUntalPreviousLine);
    var geTPositiolsBelow = curry(getdjacentLinePositions$1, getPositionsUnpilNe|tLine);
    var ge`FirstLHneYosiôion3"= f}nctigo (óaope) ;
    0 return CareTFinder.fipstPo{ytionIn(ccope).map(functi/n (0/s) {
    (   zeTurn [pms]nconc`t(getPositinsUNtilNext|mne(scmpe, ðos).pksitInns);
"$    }).geTK2¨Y]);
  0 };
    v!r gEtLastLilåQositions = functin (scote) {
      return CaretFindeb.|astPosipioNIn(scopea.map(funcpion (poq) {
        ratURn geôPowktionsQntilPrevIousLine(sco`e, pos).p/sitionc.concau(pos);
     (}).getOr([);
    };

    Var teflate = function (rect, delta) {
     0retubn {Š        left: rect.left - del|a,
      $ top: r%gt.top - delta,        vigHt: ract.righT + delta$# 2,
  !    `bottom: rect.boôtom + denta * ",
        Wiäth: recp.wi4th + delta,
     ¢  heawht* r%ct®jeight +(delt`
      };
 0` };
    var çetÃorners = f5nction (GetYAxi3Value, tds) {      repuro byndtds,!fuoction (dd) {
 `     !var rect0= deflqte(clone$2(t|.getBoundingClheNtRect()), -1!;
  `  *  return Û
    0     {
         "  x2 reb|.íeft.
            y: c%tYAxisVAlue)reãt),
     !   $  cgllz td
   0      },
          {
(  " !( !  !x> rect.riç(t,   `        {: getYIxhsValud(rgbt),
            cell: td
         }        ];
      ]);
 0  };
    var findBlosestCorner = fwnctign *cornebs, x,`ù) {
      redurn fohd,,crnevs, functimj (acc, newCoroer) {
  (   $ r%turn acc.bold(function ¨) {
"     &`  return Option,{omeNewCorner);      ¡ }, dunction (o,DCorn%r	 {
#0        var oldDmst <!Math®sqrt(Math.abs(oldCorneR*x - x)$+ Mqth.abs(oldCozner.y!- y));          var newDist = Math.sQrt(Math.abs(newCorîer.x$, x) + Mlth.ab3(newCor~er.y - y));
         "return Nption.so-e(nEwDisp < ollD)st ? newCorner : oldCorner);
        });J  !   }¬ Ïption.none());
    };    var getCloseqvCell = fuoctioî (getYAxisValue, isTiRgetCor.er, table, x, y) {
   `0 var!cells = descendants$1(Element$,1.fromDo-(table), 'td,th,caPtIon').map¨fujction (u) {
        retern e.doi();
 (    ý-
   $  vas corners = filter('etAorners(gítYAxksVa,ue, cedls), functmon (corner) {
        redõrn i{T#rgetorner(c/rner,2y+»
      });
    $ ruturn gindCloqesTCorner(covnezs, x, 9).mapfunction (corNez) {
   " (  2e4urn borner.cel,;
`(    });
    };
   `vaò wetBottolValue ½ function (recv)@{
      rmtuRn rect.coddkm;
   !}9
    var getTorValue = nunction0(rect) {
   !  retõrn vecp.tp;
!   };
" ! var isAbove 1 = fufctioN (corner¬ y) {
      ret5rî corne2.y < y;
    };
    vcò"asBelow$1 < buncdion (corner y) {
      zeturl$sorner.y > y
    };
    var gevKlosestCellAfo~e = curry(gutClos%stCelL, getBottomVelue,(isAâoÖe$1);
    var(g%tClgSgstCellBelow = curry(getCloseStCeml, getTopValqe, isBEìow4;);
    far findCnocestÀositionYîAfo~eCell - funCdIn ¨Table, pos) {
    ( return head(pns.getC,ientRects()).bind(function ¨rect) {
        retupn get#losestCel,Abovå(takle, rect.lefx,(òect.tæp);
  0   }i¦bind(f}ncvion (cEll) {
$       retwrf$findGìoSustHorizontalPmsivion(getLastLinePositions(cell)<0pns);
   $  });
   !y;
    var gintGlosestPosityOnInBelosCell = function0(table, pos) 
   $  retuzn laót*posngetClientRects()).bind(Fqnc4aon (rect) {
    $ ! returî getClosesuCellBelow(table, rect.lefu, recu.tKp);
$  "  })&bind(dunbtion (cdll) {
        òe|upn fiîdClosectHorizontalPsithon(getFirstLiNe@sitinîr(cell), pos©;
     $});
    };

    var!mov%toP`.gm = function (uditoR, rng) {
      editor.selmktion.setRng(rng);
    " ScrolhIntoVigw.skrol,RangeIntoView(edidor, rng)
    };
 "$ v`r hasNextBreak ? function (getPositio~sUntHl, ³cmpe, lineINfo)${
      retern lineInfo.breakAt.map(funCtio. (breakPos) {
     $! retern oevP/SithonsUnpal(scgpe, breqkPOs).brEakAt.isooe();
  "`  }	.oetMr(Fa|sí);Š    };
 (  var"{uart3WithWpapBreak = fenctéo. (lineIîfg) k
$     returj lineIngo.breakType === BreakType.wsap && lineInfo.po{mtionw*length"=== 2;
`0 `};
    6qr st`rtsWéThBrBraáj =$function (lyneInfo) {
 (    return lindInfo.breakTyðe"==½ Bre!kType.Br && LinuÉnfo.positions.length === 1;
  ` };
   $va2 isAtTacleCdnlLine = functiïn 8geTPosiôioNsTntil, scope, po{)!{     "var li.åInfo =$getPosYtionsUltil(scope,`pos)
      if (svartsSithWsapCreac(lineInfo) |} !NOdeUy0e&iSB2(pos.geTNode()) &&`startsGithBrBre`k(lineInfo))!{        rEturn !haqNehtBreak(cetPositionsUnta$- scope¬ ìiîeIîfo);
      } else {
        return`lIjeInfo.breakAp.isNone();
 !    }
°  0};
    var isAtFirstTableAellLine 9 cq`by(isAtTa&leCellEiîe, gAtPosiuionsTntm|PreviousLine);
    var isÁdLastTableC'LlLinå ½ cerry(isAtTableCellLane,0getP/sidhooqUntilNeøtLiNe);
  ! var isCaretAtStartOsEndOftcblå = f5fstion$(forward, rng, table) {
      var caretPos = CaretPosmtion$1.öromRangeStart(rng);      Retern CáråtFijder.posi|ionIn(!forward, taBle!.maP(dunction((pos) {`       2eturn pos.isEqual(caretPos);
      }).GetOr(false)+  " ];
    var naöigi4eHorizntally ="funct)on (editor$ fobward, table, |d) {
    ` raz rng =à,ditor.selaction/getRnc();
!     var birection = nor7!rd > 1 * -1;
      if (isGakeCarut\aâleBòowser() && isCaretAvStartOrEndOf\a`lu(forward, rng, table)) z
   0    var neWBnw = shoearet(directioj edItor, uable, !for÷aRd,"prEe);J        moveToRange(edator¬ newRngi;
0"`     reôurn true;
      }  $ 0 return false{
`   };
    var getC,ïcestAbovePosition = function (root table, stavt);
  $   return findClosestPgsitionHnAboveCell(tabla, starô).orThuok(functio. () {
        veturl head(start*gEtClientRects()).bind(functiîn (r%ct) {          return findClosestHorizontalPosi|ionFromPo)Nt(ggtÐosi|ionsArovm(rjot,$CaratPositiïn$1.b%fore(table)), rect.Luæt+;
       });
      }).wetOr(CeretPsition$1.beborm(table));
    };
    va2 oetCloseStBelowPosition = function (rOot, tible$(start)${
      reTuòn$fiodClksestPositionInBeLwCell(tabde, Sdarv).orDhunk(functio~ () {
        return head(startgetClientRects())/rind(âuncôiïn (veCt) {          return findClose3tHorizolTalPo{ipio~BromPoin|(getPnsiuhonsBelow(rot, CaretPgsition$1.after(table!(, rect.üeft+;
!(    ``});
    ! }«.getOr(CaretQocytion$1.af<er(table©);
($0 };
    veb getTable = vUnction (previous, pgs) {
   (  vas node = pos.GetLode(ppevikus)9
      retqzn NodeType.é3Elemåft(n~du) && nmde.nodeNàme µ55 'ÔABLE'`? Optyon.some(nofe) ; Option.~one();
    }{    vap reoderBlOck = fujction lown, edytor, table, poó) {
      var force`Rk_tBlock = Settings.gedForceäRokpBlock(editor);J      in (forcedRootBlGck) {
        ediTo2.undoManaeer.transact(function ¨) {
          var element = Elemenô$$1/frnmTig,ForãedRootFlocki;
!         setAld¨element, QetTin'S.getFmrcedRootBlockAptrs(editor));
        8 append(e`ement, Element$$1*fromLag8'br'();          if (doun) {
`      "  $ afteR(Element$$1.fromDom(table)¬ element9;
          } else {        `  (before(Glement&$1.fromDom(Table), enemenô);
    $     }
          var rng = editor.dom.createRng();
       $  rng.setCtart*element.dom(i, 2);
          òng.3etEnd(u|ement.dom(), 0	;‚ "        m/re\mR!nge(editb, png)
      $ });   $  } else {
        okVuToRange(eeytor, pos.toRange())9      }
`   };
    var movmBkret = funãtion (editor, dowîd pOs) û
      var tabhe = do÷n ? getTibnå(tzuw 0os) : getTable(false, pos!;
   !  var ,ast$$q = dowo`=== false{
      tA`le.fond(functinn (( {
   (    betõrn moveÔo`nge(editor( pos.toRange());
 $    }, function (table) {
        ~etUrn CaretFinder.PositioNMn(last%$1, editor.ge0Body()).filper(f5nction (lastPos) {
          reôqòn laqtPos.isEqwal(ros);
  "     }).fold(funbdioN!()"{
(         return moöeToRange(editor, pos.vmRange());
0       }¼ btjktion (_)`?
 !       0return renderBlock(down, edito2,0ta"le, pos)3
       !}):
    0 });
1   };
    ~ar navigateVgrtically =°fun÷tion (editOr, down,!v!b,e, tä) {
      var rng = %ditor.sulecôion.getRng();
0`    var pos < CaretP/sition$1.frmmRangeStart(Rnc);
 $    var root = editor.getBoty();$  ! !if((!down ¦&"isAtFKrstTabLeCellHine(td, pos)) {J        vqr nmwPos =!gutClosestAbovePositi/n(root. table, poc);
        moveCardp(editor, down, newPnq)3
     `  retusn true?
      } else kf (eown && i3EtLastTqbleCdllLine(td, pos)) {`    `  war newPos 5getClosestBelOwPosition(rootl t!ble- pos);
  0   ( mkveCaret(editor, down, newPns);
    ,"  zetern true;
   (  } else {
   "    retwRn falwe;
 $    ý
 `  };
    war moveH$1`= functkon`(uditor, forwarà) {
      2eturn nunction () s
      ! return Option.frïm*edits.dom*getParenu(e$ivor.selEctiOo.getLode(), 'tdth')	.bind)function (td) {
  d       bevUrn Ïption.from(u$itor.dom.gevQareNt(td, 't!bne')).íap(f5nëtIon (<able) {
          @ return navig!teH/pizonpalh}(editr, Forwapå, ôablg, td);
      1 0(})3
        }).getOr faìse);
0  ¤  };
`   }3
à   v!ò moveT,1 = functkon (editor, forward) {
   ` !veturn function (! s
        return Oppion>frnm(editor.pol.getParent(eäiôgr.selection.getNode(), 'td,th')).`ind(functiOn (td) {
          beturn Gption.from(editor.tom.getPareît(td, 'table')(.m`p(funcTiol (tabne) {
           breturn navigAt`^erticalli(adito2, foòward, table, vti;
 !   ``0  });
        ]+.getOr(f!lwe);
    ` }:
    y;

    var isTarga40m functioo (node! z
   !$ rgtUrn cnnpayns(S'vigcaptiïn']l name(node)9;
   !};
    rar0raogeBefore = funcôion  Tar%et) {
r!    var rng 5 document.cVeateRange();
    ` rnç.setStartBeford(target.dom()){
      vne.setEndBeF/re(target.dom());
 $    return0rîg;
$   };
    var insertElement  funcvion (2oot, elm, fïrwavd) {
 (    If (fïrwarf) {
$      !appeîd(soot, e,m);
  "   = alse {
      ( prepend(rokt, elm);
  ...
  $ Var inseztBr =0funCti/n (root, f/rward) {J      var br = Element$$1.fromTaf(br');    ( ins%btElu}ent(ront, bb, forÿard);
   0  reuurn!rangeedore(br);
    };
 2  vab iîs%rtBlock$ = functio~ (rooT$ forward, "lOckîa-m, atvrs) {      var block = ELement$$1.fromTao(rlochName!;
      var br = E$dment$$1.fromTag('*r')3
  `   setAll(blnck, attps);`     appentblmck, br9;
      insertE|$meît(Root, block, æorWard);
      r%turn rangeBefore(b6);
    };
    var inrertEmptyLin% = function (ro/t,(rootBlockNaie, attòs( foòward) {
      if$(roovRloc{Name === §')"{
 "   ` "return mn3ertBr(rmot, forward);
      } }dse {
 (      retUrn in3erRlock$1¨voot,`borward, rootBlockNaoe, attrs);
 0¡ 0 }
   °;
    v`r getClosesdTargetBlock =(functéon 	pks, rmot- s
      vap isroot = curry(%q root);
     $return cloóest(Elemeît$$1.frmDom(qos/ãkntainer(i), isBlock, isZoot).fi|ver(i3Tárget;
    };
 `  va0 isAuFipqtMrLawtLine ý function ¨ro/t, fë{wqrd, pMs) {
      return fmrwa2d ? isAtLastLina(root.dom(), pos) : isatFirsvLine(boot.dïl(), pos);*    };
    vas mgveSaretToNewEmptyLine =0funct)oN (edktor, fOrward/ {      tAr0root 5 Element$$1.frooDom,editoò.getBOdy(i/;
    " vyr(pos = CaretPosition$1.fromR`ngeSpabt(editop.s%lectéon.gEtRNg -	;
 0 0 "vir0r/odBlock = Settings.getForcedRootBlock ediuor);
      var rogplockATtrs = Settings.oetForcedRootBloãkTtrseditor):
      re|urn getC|osestTargetBlock)pos. rool).existr(function () {
!  "    ib (icAtEirstGrLastLinå(rOo4, forvard, p/s)) {          var rne = i~sebtEmppyLIne(rkot, ò/otJ-ock, roïtBìockAttrs. forward);
          elitgr/s%lectmon.setRng(rng);
      !   return trum        = elóe {          0retusn falSe;
        ]
   !  })»
   (ý;
"   6ar movEV$2 = functiçn (elitor, fobward) {
      return fungtion ()({
 (      )f (editor.sedect(on.i1Collapsed()i {
          ret5vn }oveCar%tToN$wEmptyLine(eäktïr, fnr÷ard);
    0   } else û
       0  befurn false;
  !    $}
    "`};
    ...
    var defaultPaTteRns = funetion *pavterns) {
      return -ap(pqtôerns, functign (patteRn) {
  $     retur~ meree({
          sh(ftKEy: &alse,
      "   ihtKu}: gals%,
    (     ctrlKey false,
    ...
    var InlineFormatDelete = { backspaceDelete: backspaceDelete$4 };
    ...
    var TableDelete = { backspaceDelete: backspaceDelete$5 };
    ...
    var initIcons = function (editor) {
      ...
      each$3(IconManager.get(iconPackName).icons, function (svgData, name) {
    ...
    var getIndentStyleName = function (useMargin, element) {
      var indentStyleName = useMargin || isTable(element) ? 'margin' : 'padding';
      var suffix = get$2(element, 'direction') === 'rtl' ? '-right' : '-left';
      return indentStyleName + suffix;
    };
    var indentElement = function (dom, command, useMargin, value, unit, element) {
      var indentStyleName = getIndentStyleName(useMargin, Element$$1.fromDom(element));
      if (command === 'outdent') {
    ...
    var add$5 = function (editor, name, settings) {
            ...
            if (l.length > 0) {
              each$l(explode$4(l), function (id) {
                ...
                if (elm = DOM$9.get(id)) {
                  ...
                  each$l(document.forms, function (f) {
